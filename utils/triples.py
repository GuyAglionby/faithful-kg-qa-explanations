...
#
#
# # def generate_triples_from_adj(adj_pk_path, mentioned_cpt_path, cpnet_vocab_path, triple_path, graph):
# #     if os.path.exists(triple_path):
# #         print(f'triples already exist at {triple_path}')
# #         return
# #     global concept2id, id2concept, relation2id, id2relation
...
#
#
# # def generate_triple_string(str_template_path, cpnet_vocab_path, triple_path, output_path, graph, num_processes=1):
# #     # ga384 2021/02/18 not used
# #     # This is their version of how to generate bert-based node embeddings for cpnet
